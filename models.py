...
class Character:
    '''Класс персонажа'''
    def __init__(self,login,name,heals=10,
                 streng=1,intel=1,dexterity=1,spirit=1,endurance=1,
                 head=None,armour=None,shoulders=None,gloves=None,legs=None,boots=None,
                 exp=0,level=1):
        self.acсount = login
        self.name = name
        self.heals = heals
